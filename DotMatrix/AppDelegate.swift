...
class AppDelegate: UIResponder, UIApplicationDelegate, UIApplicationDelegateWithPSC {
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "vaderapps.com.DotMatrix" in the application's documents Application Support directory.
